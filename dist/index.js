...
var require_AuthenticationDetails = __commonJS((exports) => {
...
var require_cryptoSecureRandomInt = __commonJS((exports) => {
  exports.__esModule = true;
...
var require_WordArray = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  var _cryptoSecureRandomInt = _interopRequireDefault(require_cryptoSecureRandomInt());
...
var require_BigInteger = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
...
var require_AuthenticationHelper = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  var _buffer = __require("buffer");
  var _WordArray = _interopRequireDefault(require_WordArray());
  var _sha256Js = require_build2();
  var _BigInteger = _interopRequireDefault(require_BigInteger());
  function _interopRequireDefault(e) {
    return e && e.__esModule ? e : { default: e };
  }
  /*!
...
var require_CognitoJwtToken = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  var _buffer = __require("buffer");
  /*!
...
var require_CognitoAccessToken = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  var _CognitoJwtToken2 = _interopRequireDefault(require_CognitoJwtToken());
  function _interopRequireDefault(e) {
    return e && e.__esModule ? e : { default: e };
  }
  ...
  var CognitoAccessToken = exports.default = /* @__PURE__ */ function(_CognitoJwtToken) {
    function CognitoAccessToken2(_temp) {
      var _ref = _temp === undefined ? {} : _temp, AccessToken = _ref.AccessToken;
...
var require_CognitoIdToken = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  var _CognitoJwtToken2 = _interopRequireDefault(require_CognitoJwtToken());
  function _interopRequireDefault(e) {
  ...
  var CognitoIdToken = exports.default = /* @__PURE__ */ function(_CognitoJwtToken) {
    function CognitoIdToken2(_temp) {
      var _ref = _temp === undefined ? {} : _temp, IdToken = _ref.IdToken;
      return _CognitoJwtToken.call(this, IdToken || "") || this;
    }
    _inheritsLoose(CognitoIdToken2, _CognitoJwtToken);
    return CognitoIdToken2;
  }(_CognitoJwtToken2["default"]);
});

// node_modules/amazon-cognito-identity-js/lib/CognitoRefreshToken.js
var require_CognitoRefreshToken = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  /*!
   * Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
  ...
  var CognitoRefreshToken = exports.default = /* @__PURE__ */ function() {
    function CognitoRefreshToken2(_temp) {
      var _ref = _temp === undefined ? {} : _temp, RefreshToken = _ref.RefreshToken;
...
var require_Platform = __commonJS((exports) => {
  exports.__esModule = true;
  exports.getUserAgent = exports.default = exports.Platform = undefined;
...
var require_CognitoUserSession = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  /*!
   * Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
  ...
  var CognitoUserSession = exports.default = /* @__PURE__ */ function() {
    function CognitoUserSession2(_temp) {
      var _ref = _temp === undefined ? {} : _temp, IdToken = _ref.IdToken, RefreshToken = _ref.RefreshToken, AccessToken = _ref.AccessToken, ClockDrift = _ref.ClockDrift;
...
var require_DateHelper = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  /*!
   * Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
...
var require_CognitoUserAttribute = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  /*!
   * Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
  ...
  var CognitoUserAttribute = exports.default = /* @__PURE__ */ function() {
    function CognitoUserAttribute2(_temp) {
      var _ref = _temp === undefined ? {} : _temp, Name = _ref.Name, Value = _ref.Value;
      this.Name = Name || "";
      this.Value = Value || "";
    }
...
var require_StorageHelper = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = exports.MemoryStorage = undefined;
  /*!
   * Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
   * SPDX-License-Identifier: Apache-2.0
   */
...
var require_CognitoUser = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  var _buffer = __require("buffer");
  var _sha256Js = require_build2();
  var _Platform = require_Platform();
  var _BigInteger = _interopRequireDefault(require_BigInteger());
  var _AuthenticationHelper = _interopRequireDefault(require_AuthenticationHelper());
  var _CognitoAccessToken = _interopRequireDefault(require_CognitoAccessToken());
  var _CognitoIdToken = _interopRequireDefault(require_CognitoIdToken());
  var _CognitoRefreshToken = _interopRequireDefault(require_CognitoRefreshToken());
  var _CognitoUserSession = _interopRequireDefault(require_CognitoUserSession());
  var _DateHelper = _interopRequireDefault(require_DateHelper());
  var _CognitoUserAttribute = _interopRequireDefault(require_CognitoUserAttribute());
  var _StorageHelper = _interopRequireDefault(require_StorageHelper());
  function _interopRequireDefault(e) {
    return e && e.__esModule ? e : { default: e };
  }
  /*!
  ...
  var CognitoUser = exports.default = /* @__PURE__ */ function() {
    ...
    _proto.isFetchUserDataAndTokenRequired = function isFetchUserDataAndTokenRequired(params) {
      var _ref = params || {}, _ref$bypassCache = _ref.bypassCache, bypassCache = _ref$bypassCache === undefined ? false : _ref$bypassCache;
      return bypassCache;
    };
    ...
    _proto.revokeTokens = function revokeTokens(revokeTokenCallback) {
      if (revokeTokenCallback === undefined) {
...
var require_unfetch = __commonJS((exports, module) => {
...
var require_isomorphic_unfetch = __commonJS((exports, module) => {
  function r(m) {
    return m && m.default || m;
  }
  module.exports = global.fetch = global.fetch || (typeof process == "undefined" ? r(require_unfetch()) : function(url, opts) {
    return r(require_lib2())(String(url).replace(/^\/\//g, "https://"), opts);
  });
});
...
var require_constants2 = __commonJS((exports) => {
  exports.__esModule = true;
  exports.FRAMEWORK = exports.AUTH_CATEGORY = undefined;
...
var require_UserAgent = __commonJS((exports) => {
  exports.__esModule = true;
  exports.getAmplifyUserAgent = exports.default = exports.appendToCognitoUserAgent = exports.addFrameworkToCognitoUserAgent = exports.addAuthCategoryToCognitoUserAgent = undefined;
  var _Platform = require_Platform();
...
var require_Client = __commonJS((exports) => {
  ...
  function retry(functionToRetry, args, delayFn, attempt) {
    ...
    return functionToRetry.apply(undefined, args)["catch"](function(err) {
...
var require_CognitoUserPool = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  var _Client = _interopRequireDefault(require_Client());
  var _CognitoUser = _interopRequireDefault(require_CognitoUser());
  var _StorageHelper = _interopRequireDefault(require_StorageHelper());
  function _interopRequireDefault(e) {
    return e && e.__esModule ? e : { default: e };
  }
...
var require_CookieStorage = __commonJS((exports) => {
  exports.__esModule = true;
  exports.default = undefined;
  var Cookies = _interopRequireWildcard(require_js_cookie());
...
var require_lib3 = __commonJS((exports) => {
  exports.__esModule = true;
  exports.appendToCognitoUserAgent = exports.WordArray = exports.DateHelper = exports.CookieStorage = exports.CognitoUserSession = exports.CognitoUserPool = exports.CognitoUserAttribute = exports.CognitoUser = exports.CognitoRefreshToken = exports.CognitoIdToken = exports.CognitoAccessToken = exports.AuthenticationHelper = exports.AuthenticationDetails = undefined;
  var _AuthenticationDetails = _interopRequireDefault(require_AuthenticationDetails());
  ...
  var _CognitoUserPool = _interopRequireDefault(require_CognitoUserPool());
...
// src/auth/cognito-auth.ts
var import_amazon_cognito_identity_js = __toESM(require_lib3(), 1);
...
// src/constants.ts
var COGNITO_USER_POOL_ID = "us-east-2_ghlOXVLi1";
var COGNITO_CLIENT_ID = "4qte47jbstod8apnfic0bunmrq";
var API_BASE_URL = "https://api.emporiaenergy.com";
var MAINTENANCE_URL = "https://s3.amazonaws.com/com.emporiaenergy.manual.ota/maintenance/maintenance.json";
var API_ENDPOINTS = {
  CUSTOMERS: "/customers",
  CUSTOMERS_DEVICES: "/customers/devices",
  CUSTOMERS_VEHICLES: "/customers/vehicles",
  APP_API: "/AppAPI",
  DEVICE_CHANNELS: (deviceGid) => `/devices/${deviceGid}/channels`,
  CHANNEL_TYPES: "/devices/channels/channeltypes",
  LOCATION_PROPERTIES: (deviceGid) => `/devices/${deviceGid}/locationProperties`,
  DEVICE_STATUS: "/customers/devices/status",
  OUTLET: "/devices/outlet",
  CHARGER: "/devices/evcharger",
  VEHICLE_STATUS: (vehicleGid) => `/vehicles/v2/settings?vehicleGid=${vehicleGid}`
};
var DEFAULT_CONNECT_TIMEOUT = 6030;
var DEFAULT_READ_TIMEOUT = 10030;
var DEFAULT_MAX_RETRY_ATTEMPTS = 5;
var DEFAULT_INITIAL_RETRY_DELAY = 100;
var DEFAULT_MAX_RETRY_DELAY = 5000;
...
// src/errors.ts
class EmporiaVueError extends Error {
  constructor(message) {
    super(message);
...
class AuthenticationError extends EmporiaVueError {
  constructor(message) {
    super(message);
...
class ApiError extends EmporiaVueError {
  statusCode;
...
class NetworkError extends EmporiaVueError {
  constructor(message) {
    super(message);
...
class TimeoutError extends EmporiaVueError {
  constructor(message) {
    super(message);
...
class CognitoAuth {
  ...
  tokenUpdater;
  readTimeout;
  constructor(_connectTimeout = DEFAULT_CONNECT_TIMEOUT, readTimeout = DEFAULT_READ_TIMEOUT) {
  ...
  async login(username, password) {
    return new Promise((resolve, reject) => {
      ...
      const authDetails = new import_amazon_cognito_identity_js.AuthenticationDetails({
        Username: username,
        Password: password
      });
      this.cognitoUser.authenticateUser(authDetails, {
        ...
        onFailure: (err) => reject(new AuthenticationError(err.message || "Authentication failed")),
        newPasswordRequired: () => {
          reject(new AuthenticationError("New password required - not supported"));
        }
      });
    });
  }
  ...
  async refreshTokens() {
    ...
    return new Promise((resolve, reject) => {
      const refreshToken = new import_amazon_cognito_identity_js.CognitoRefreshToken({
  ...
  async request(method, url, data, params) {
    ...
    const urlWithParams = params ? `${fullUrl}?${new URLSearchParams(params).toString()}` : fullUrl;
  ...
  setTokenUpdater(callback) {
    this.tokenUpdater = callback;
  }
  extractTokensFromSession(session) {
    this.tokens = {
...
((Unit2) => {
  Unit2["VOLTS"] = "Voltage";
  Unit2["KWH"] = "KilowattHours";
  Unit2["USD"] = "Dollars";
  Unit2["AMPHOURS"] = "AmpHours";
  Unit2["TREES"] = "Trees";
  Unit2["GAS"] = "GallonsOfGas";
  Unit2["DRIVEN"] = "MilesDriven";
  Unit2["CARBON"] = "Carbon";
})(Unit ||= {});
...
class VueDeviceChannel {
  ...
  static fromApiResponse(data) {
    ...
    channel.channelMultiplier = data.channelMultiplier ?? 1;
...
class VueDevice {
  ...
  populateLocationProperties(data) {
...
// src/models/usage.ts
class VueDeviceChannelUsage extends VueDeviceChannel {
  usage;
  percentage;
  timestamp;
  nestedDevices = [];
  static fromApiResponse(data) {
    ...
    usage.channelMultiplier = data.channelMultiplier ?? 1;
    ...
    if (data.nestedDevices) {
      usage.nestedDevices = data.nestedDevices.map(VueUsageDevice.fromApiResponse);
    }
    return usage;
  }
}

class VueUsageDevice extends VueDevice {
  timestamp;
  channelUsages = new Map;
  static fromApiResponse(data) {
...
class EmporiaVue {
    ...
    if (this.tokenStorage) {
      try {
        ...
        if (stored) {
          ...
          this.auth.setTokenUpdater((tokens) => this.saveTokens(tokens, username));
          return true;
        }
      } catch {}
    }
  ...
  async loginSimulator(host, username, password) {
  ...
  async getDevices() {
    const response = await this.auth.request("GET", API_ENDPOINTS.CUSTOMERS_DEVICES);
    const devices = [];
  ...
  async populateDeviceProperties(device) {
    const response = await this.auth.request("GET", API_ENDPOINTS.LOCATION_PROPERTIES(device.deviceGid));
    device.populateLocationProperties(response);
    return device;
  }
  async getDevicesStatus(deviceList) {
    const devices = deviceList ?? await this.getDevices();
    const deviceGids = devices.map((d) => d.deviceGid);
    const response = await this.auth.request("GET", API_ENDPOINTS.DEVICE_STATUS, undefined, {
      deviceGids: deviceGids.join(",")
    });
    return {
      outlets: (response.outlets ?? []).map((o) => OutletDevice.fromApiResponse(o)),
      chargers: (response.evChargers ?? []).map((c) => ChargerDevice.fromApiResponse(c))
    };
  }
  async getDeviceListUsage(deviceGids, instant, scale = "1S" /* SECOND */, unit = "KilowattHours" /* KWH */, retryOptions = {}) {
    const {
    ...
    for (let attempt = 0;attempt < maxRetryAttempts; attempt++) {
      const response = await this.auth.request("GET", API_ENDPOINTS.APP_API, undefined, params);
      usageMap = new Map;
      ...
      const allComplete = deviceGids.every((gid) => {
        ...
        return device.channelUsages.size === 0;
      });
      if (allComplete) {
        return usageMap;
      }
  ...
  async getChartUsage(channel, start, end, scale = "1H" /* HOUR */, unit = "KilowattHours" /* KWH */) {
    const params = {
    ...
    return {
      ...
      firstUsageTime: response.firstUsageInstant ? new Date(response.firstUsageInstant) : null
    };
  }
  async updateOutlet(outlet, on) {
    if (on !== undefined) {
      outlet.outletOn = on;
    }
    const response = await this.auth.request("PUT", API_ENDPOINTS.OUTLET, outlet.toApiPayload());
    return OutletDevice.fromApiResponse(response);
  }
  async updateCharger(charger, on, chargeRate) {
    if (on !== undefined) {
    ...
    const response = await this.auth.request("PUT", API_ENDPOINTS.CHARGER, charger.toApiPayload());
    return ChargerDevice.fromApiResponse(response);
  }
  async updateChannel(channel) {
    const response = await this.auth.request("PUT", API_ENDPOINTS.DEVICE_CHANNELS(channel.deviceGid), [channel.toApiPayload()]);
    if (response && response.length > 0) {
      return VueDeviceChannel.fromApiResponse(response[0]);
    }
    return channel;
  }
  async getVehicles() {
    const response = await this.auth.request("GET", API_ENDPOINTS.CUSTOMERS_VEHICLES);
    return (response ?? []).map((v) => Vehicle.fromApiResponse(v));
  }
  async getVehicleStatus(vehicleGid) {
    try {
      const response = await this.auth.request("GET", API_ENDPOINTS.VEHICLE_STATUS(vehicleGid));
  ...
  async getCustomerDetails() {
    try {
      const response = await this.auth.request("GET", API_ENDPOINTS.CUSTOMERS);
  ...
  async getChannelTypes() {
    const response = await this.auth.request("GET", API_ENDPOINTS.CHANNEL_TYPES);
    return (response ?? []).map((ct) => ChannelType.fromApiResponse(ct));
  }
  async downForMaintenance() {
    try {
      const response = await this.auth.request("GET", MAINTENANCE_URL);
  ...
  async saveTokens(tokens, username) {
    if (!this.tokenStorage)
      return;
